...
import { hidePedestal } from "./pedestal"
...
export async function downloadScheduleData() {
  ...
  export function setupSchedulControllerData(){
    ...
    if(scheduleController){
        ...
        getActions("scheduleController")?.on("Next", () => {
            ...
            setFeaturedUser(jsonData[scheuldeIndex].name, jsonData[scheuldeIndex].avatarName)
  ...
  export function setFeaturedUser(name:string, avatarName:string){
